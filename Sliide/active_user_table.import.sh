...
cat ./active_user_table.schema.sql      | tee /dev/stderr | sqlite3 active_user_table.db
echo
./count_user_engagements_by_date.sh     | tee /dev/stderr | sqlite3 active_user_table.db
echo
